 ...
 -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" class="content_available" name="display_is_custom" value="1" <?php echo set_checkbox('display_is_custom', '1', (set_value('display_tbl', $cus_field->visible_is_custom) == 1) ? TRUE : FALSE); ?>>
