            ...
            <div class="box border0 mb0">
                <div class="nav-tabs-custom border0 mb0" id="tabs">
                    <ul class="nav nav-tabs navlistscroll">
                        ...
                        <?php if ($this->rbac->hasPrivilege('nurse_note', 'can_view')) { ?>
                            <li>
                                <a href="#admission_note" data-toggle="tab" aria-expanded="true"><i class="fas fa-sticky-note"></i> <?php echo $this->lang->line('admission note'); ?></a>
                            </li>
                        <?php } ?>

                        <?php if ($this->rbac->hasPrivilege('nurse_note', 'can_view')) { ?>
                            <li>
                                <a href="#description_comment" data-toggle="tab" aria-expanded="true"><i class="fas fa-sticky-note"></i> <?php echo $this->lang->line('description_comment'); ?></a>
                            </li>
                        <?php } ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane tab-content-height active" id="overview">
                            <div class="row">
                                    ...
                                    <div class="box-header border-b mb10 pl-0 pt0">
                                        ...
                                        <div class="pull-right">
                                            <div class="editviewdelete-icon pt8">
                                                ...
                                                ?>
                                                            <a class="" href="#" onclick="get_hoja_ingreso('<?php echo $ipdid ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('hoja_ingreso'); ?>"><i class="fa fa-book"></i>
                                                            </a>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-body">
                                                                        <?php echo $this->lang->line('subjective') . "</br>" . nl2br($nurse_note[$i]['note']); ?>
                                                                    </div>

                                                                    <div class="timeline-body">
                                                                        <?php echo $this->lang->line('evolution') . "</br> " . nl2br($nurse_note[$i]['comment']); ?>
                                                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="row">
                                        <div class="col-md-6 project-progress-bars" style="display: none;">
                                            <div class="row">
                                    ...
                                    <div class="box-header pl-0">
                                        <h3 class="text-uppercase bolds mt0 mb0 ptt10 pull-left font14">
                                            <?php echo $this->lang->line('historial_medicamentos'); ?>
                                            <a class="" href="#" onclick="print_medicamentos_2('<?php echo $ipdid ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('hoja_ingreso'); ?>">
                                    ...
                                    <div class="box-header pl-0">
                                        <div class="table-responsive">
                                            <?php
                                            if (!empty($medicationreport_overview_antes)) {
                                            ?>
                                                <table class="table table-striped table-bordered mb0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        for ($i = 0; $i < $recent_record_count; $i++) {
                                                            if (!empty($medicationreport_overview_antes[$i])) {
                                                        ?>
                                                                <tr>
                                                                    <td><?php echo $this->customlib->YYYYMMDDTodateFormat($medicationreport_overview_antes[$i]['date']); ?></td>
                                                                    <td><?php echo $medicationreport_overview_antes[$i]['medicine_name'] ?></td>
                                                                    <td><?php echo $medicationreport_overview_antes[$i]['dosage']; ?></td>
                                                                    <!-- <td><?php echo $medicationreport_overview_antes[$i]['medicine_dosage'] . " (" . $medicationreport_overview_antes[$i]['unit'] . ")"; ?></td> -->
                                                                    <td><?php echo $this->customlib->getHospitalTime_Format($medicationreport_overview_antes[$i]['time']); ?></td>
                                                                    <td><?php echo $medicationreport_overview_antes[$i]['remark']; ?></td>
                                                                </tr>
                                                        <?php
                                                            }
                                                        }
                                    ...
                                    <!--  -->
                                    <div class="box-header pl-0">
                                        <h3 class="text-uppercase bolds mt0 mb0 ptt10 pull-left font14"><?php echo $this->lang->line('medication'); ?>
                                            <a class="" href="#" onclick="print_medicamentos('<?php echo $ipdid ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('hoja_ingreso'); ?>">
                                                <i class="fa fa-print"></i>
                                            </a>
                                        </h3>
                                        <div class="pull-right">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $medicationreport_overview[$i]['dosage']; ?></td>
                                    ...
                                    <div class="box-header mb10 pl-0" style="display: none;">
                                    ...
                                    <div class="box-header mb10 pl-0">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered  mb0" style="display: none;">
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-transform: capitalize;"><?php echo $charges[$i]["name"] ?>
                                                                        <div class="bill_item_footer text-muted"><label><?php if ($charges[$i]["note"] != '') {
                                                                                                                            echo $this->lang->line('charge_note') . ': ';
                                                                                                                        } ?> </label> <?php echo $charges[$i]["note"] ?></div>
                                                                    </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="mailbox-name"><?php if ($bed_history[$i]->from_date != '') {
                                                                                                    echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($bed_history[$i]->from_date));
                                                                                                } ?></td>
                                                                    <td class="mailbox-name"><?php if ($bed_history[$i]->to_date != '') {
                                                                                                    echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($bed_history[$i]->to_date));
                                                                                                } ?></td>
                                            ...
                                            ?>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-body">
                                                            <?php echo "<b>" . $this->lang->line('subjective') . "</b>" . "</br>" . nl2br($value['note']); ?>
                                                        </div>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <div class="timeline-body">
                                                            <?php echo "<b>" . $this->lang->line('evolution') . "</b>" . "</br> " . nl2br($value['comment']); ?>
                                                        </div>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <?php if ($is_discharge) {
                                                                if ($this->rbac->hasPrivilege('consultant_register', 'can_delete')) { ?>
                                        ...
                                        <tbody>
                                            <?php foreach ($bed_history as $history) { ?>
                                                <tr>
                                                    ...
                                                    <td class="mailbox-name"><?php if ($history->from_date != '') {
                                                                                    echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($history->from_date));
                                                                                } ?></td>
                                                    <td class="mailbox-name"><?php if ($history->to_date != '') {
                                                                                    echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($history->to_date));
                                                                                } ?></td>
                        ...
                        <?php if ($this->rbac->hasPrivilege('ipd_medication', 'can_view')) {  ?>
                            <div class="tab-pane tab-content-height" id="medication">
                                ...
                                <div class="download_label"><?php echo $result['patient_name'] . " " . $this->lang->line('ipd_details'); ?></div>
                                <div class="table_inner" style=" max-height: 80vh;">
                                                ...
                                                foreach ($medication as $medication_key => $medication_value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                    <td class="dosehover"><?php echo $this->lang->line('time') . ": " . $this->customlib->getHospitalTime_Format($mvalue['dose_list'][$x]['time']) . "</a><span>" . $medication_edit . "</span><span>" . $medication_delete . "</span></br>" . $mvalue['dose_list'][$x]['dosage'];
                                                                                            if ($mvalue['dose_list'][$x]['remark'] != '') {
                                                                                                echo " <br><b>" . $this->lang->line('remark') . "</b>: " . $mvalue['dose_list'][$x]['remark'];
                                                                                                echo " <br> <b>" . $this->lang->line('notes') . "</b>: " . $mvalue['dose_list'][$x]['medication_notes'];
                                                                                            } ?></td>
                                                                <?php
                                                                } else {
                                                                ?>
                        ...
                        <!-- nota de ingreso -->
                        <?php if ($this->rbac->hasPrivilege('nurse_note', 'can_view')) { ?>
                            <div class="tab-pane tab-content-height " id="admission_note">
                                <div class="box-tab-header">
                                    <h3 class="box-tab-title"><?php echo $this->lang->line('admission note'); ?></h3>
                                    <div class="box-tab-tools">
                                        ...
                                        if ($this->rbac->hasPrivilege('nurse_note', 'can_add')) {
                                            ...
                                            if ($is_discharge) {
                                        ?>
                                                <a href="#" class="btn btn-sm btn-primary dropdown-toggle addnursenote" onclick="holdModal('add_admission_note')" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add_admission_note'); ?></a>
                                        <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div id="">
                                    <?php if (empty($admission_note)) { ?>

                                        <div class="alert alert-info"><?php echo $this->lang->line('no_record_found'); ?></div>
                                    <?php } else { ?>
                                        <ul class="timeline timeline-inverse">
                                            <?php
                                            foreach ($admission_note as $key => $value) {
                                                $id = $value['id'];
                                            ?>
                                                <li class="time-label">
                                                    <span class="bg-blue">
                                                        ...
                                                        <?php if ($is_discharge) {
                                                            if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                                <span class="time">
                                                                    ...
                                                                    <a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_record('<?php echo base_url(); ?>admin/patient/deleteIpd_admission_note/<?php echo $value['id']; ?>/<?php echo $value['ipd_id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                        <i class="fa fa-trash"></i>
                                                                    </a>
                                                                </span>
                                                        <?php }
                        ...
                        <!-- Descripcion -->
                        <?php if ($this->rbac->hasPrivilege('nurse_note', 'can_view')) { ?>
                            <div class="tab-pane tab-content-height " id="description_comment">
                                <div class="box-tab-header">
                                    <h3 class="box-tab-title"><?php echo $this->lang->line('description_comment'); ?></h3>
                                    <div class="box-tab-tools">
                                        <?php
                                        if ($this->rbac->hasPrivilege('nurse_note', 'can_add')) {
                                            ...
                                            if ($is_discharge) {
                                        ?>
                                                <a href="#" class="btn `btn`-sm btn-primary dropdown-toggle addnursenote" onclick="holdModal('add_description_comment')" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add_description_comment'); ?></a>
                                        <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div id="">
                                    <?php if (empty($description_comment)) { ?>

                                        <div class="alert alert-info"><?php echo $this->lang->line('no_record_found'); ?></div>
                                    <?php } else { ?>
                                        <ul class="timeline timeline-inverse">
                                            <?php
                                            foreach ($description_comment as $key => $value) {
                                                $id = $value['id'];
                                            ?>
                                                <li class="time-label">
                                                    <span class="bg-blue">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">
                                                        <?php if ($is_discharge) {
                                                            if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                                <span class="time">
                                                                    ...
                                                                    <a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_record('<?php echo base_url(); ?>admin/patient/delete_description_comment/<?php echo $value['id']; ?>/<?php echo $value['ipd_id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                        <i class="fa fa-trash"></i>
                                                                    </a>
                                                                </span>
                                                        <?php }
                                                        ...
                                                        <h3 class="timeline-header text-aqua"> <?php echo $value['name'] . ' ' . $value['surname'] . " ( " . $value['employee_id'] . " )"; ?> </h3>
                                                        <div class="timeline-body">
                                                            <?php echo "<b>" . $this->lang->line('type_description') . "</b>" . "</br>" . nl2br($value['type_description_name']); ?>
                                                        </div>
                                                        <div class="timeline-body">
                                                            <?php echo "<b>" . $this->lang->line('note') . "</b>" . "</br>" . nl2br($value['note']); ?>
                                                        </div>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-transform: capitalize;"><?php echo $charge["name"] ?>
                                                            <div class="bill_item_footer text-muted"><label><?php if ($charge["note"] != '') {
                                                                                                                echo $this->lang->line('charge_note') . ': ';
                                                                                                            } ?> </label> <?php echo $charge["note"] ?></div>
                                                        </td>
                    ...
                    <div class="modal-body pt0 pb0">
                        <div class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('subjective') ?> <small class="req"> *</small> </label>
                                        <textarea name="note" id="enote" style="height:50px" class="form-control compose-textareass"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('evolution') ?> <small class="req"> *</small> </label>
                                        <textarea name="comment" id="ecomment" style="height:50px" class="form-control compose-textareass"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php //echo set_value('email');     
                                                                ?>" id="date" name="date" class="form-control datetime">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon">
                    <a class="pull-right" href="#" onclick="print_medicamentos_print('<?php echo $ipdid ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('historial'); ?>">
                        <i class="fa fa-print"></i>
                    </a>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name='dosage' id="mdosage" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="medication_notes" id="medication_notes" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body pt0 pb0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='dosage_id' id="medicine_dose_edit_id" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><?php echo $this->lang->line("notes"); ?></label>
                                <textarea name="medication_notes" id="medicine_dosage_medication_notes" class="form-control"></textarea>
                                ...
                                <div class="row row-eq">
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <div class="ptt10">
                                            ...
                                            <input type="hidden" id="credits_limits" value="20000" name="credit_limit" class="form-control">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6" style="display:none;">
                                                <div class="form-group">
                                                    ...
                                                    <!-- <div> -->
                                                    <!-- <select class="form-control" name='organisation' id="edit_organisations">
                                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    ...
                                    <select name="doctor_field" <?php
                                        ...
                                        <?php foreach ($doctors as $key => $value) { ?>
                                            <option <?php if ((isset($doctor_select)) && ($doctor_select == $dvalue["id"])) {
                                                        echo "selected";
                                                    } ?> value="<?php echo $value["id"] ?>"><?php echo $value["name"] . " " . $value["surname"] . " (" . $value["employee_id"] . ")" ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="doctor_field" <?php
                                                                if ($disable_option == true) {
                                                                    echo "disabled";
                                                                } ?> style="width: 100%" id="editdoctor_field" class="form-control select2">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php foreach ($doctors as $key => $value) { ?>
                                            <option <?php if ((isset($doctor_select)) && ($doctor_select == $dvalue["id"])) {
                                                        echo "selected";
                    ...
                    <div class="modal-body pb0 ptt10">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="nurse_field" <?php
                                                                if ($disable_option == true) {
                                                                    echo "disabled";
                                                                } ?> style="width: 100%" id="nurse_field" class="form-control select2">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php foreach ($nurse as $key => $value) { ?>
                                            <option <?php if ((isset($nurse_select)) && ($nurse_select == $dvalue["id"])) {
                                                        echo "selected";
                                                    } ?> value="<?php echo $value["id"] ?>"><?php echo composeStaffNameByString($value["name"], $value["surname"], $value["employee_id"]); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('subjective') ?> <small class="req"> *</small> </label>
                                    <textarea name="note" style="height:50px" class="form-control compose-textareass"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('evolution'); ?> <small class="req"> *</small> </label>
                                    <textarea name="comment" style="height:50px" class="form-control compose-textareass"></textarea>
                                </div>
                            </div>
...
<!-- nota de ingreso -->
<div class="modal fade" id="add_admission_note" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-lg-content">
            <div class="modal-header modal-lg-header">
                <button type="button" class="close close_button" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('add_nurse_note'); ?> </h4>
            </div>

            <form id="admission_note_form" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <input name="patient_id" placeholder="" id="nurse_patient_id" value="<?php echo $result["id"] ?>" type="hidden" class="form-control" />
                <input type="hidden" name="ipdid" value="<?php echo $ipdid ?>">
                <div class="scroll-area">
                    <div class="modal-body pb0 ptt10">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('admission note') ?> <small class="req"> *</small> </label>
                                    <textarea name="note" style="height:700px; width: 900px;" class="form-control compose-textareass">
                                        Se trata de paciente de __________________ años de edad, G______ P_____ A_____ C_____ E_____, natural de _________________________ y residente en ______________________________________________________________________ la cual viene vía ____________________________________________ con diagnóstico/s de:
                                        ...
                                        Paciente curso con # __________________ controles prenatales __________________________________________ se aplicó # _____________ dosis de toxoide tetánico e ingesta _____________________________________________________ de hematínicos.

                                        ANTECEDENTES PERSONALES

                                        Alérgicos: __________________________________________________ FUM: ____________________________________________

                                        Quirúrgicos: _________________________________________________ FPP: ____________________________________________

                                        Traumáticos: _______________________________________________ Inf. Vaginales: ____________________________________________

                                        Transfusionales: _____________________________________________ Inf. Vías Urinarias: ____________________________________________

                                        Actualmente paciente: ___________________________________________________________________________________________________________________________________________

                                        Con signos vitales: T.A.: _______ / _______ mmHg F.C.: _______ L/min F.R.: _______ R/min T.: _______ °C SO2: _______ %

                                        EXAMEN FÍSICO

                                        Cabeza: _______________________________________________________________________________________________________________________________________________________________
                                        Cuello: _______________________________________________________________________________________________________________________________________________________________
                                        Tórax: _______________________________________________________________________________________________________________________________________________________________
                                        Corazón: _______________________________________________________________________________________________________________________________________________________________
                                        Pulmones: _______________________________________________________________________________________________________________________________________________________________
                                        Abdomen: _______________________________________________________________________________________________________________________________________________________________

                                        Genitales Externos: _____________________________________________________________________________________________________________________________________________________
                                        Tacto vaginal: _______________________________________________________________________________________________________________________________________________________

                                        Miembros inferiores: _______________________________________________________________________________________________________________________________________________________________
                                    </textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" id="admission_notebtn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn btn-info pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
...
<!-- Descripciones  -->
<div class="modal fade" id="add_description_comment" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-lg-content">
            <div class="modal-header modal-lg-header">
                <button type="button" class="close close_button" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('add_description_comment'); ?> </h4>
            </div>

            <form id="description_comment_form" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <input name="patient_id" placeholder="" id="nurse_patient_id" value="<?php echo $result["id"] ?>" type="hidden" class="form-control" />
                <input type="hidden" name="ipdid" value="<?php echo $ipdid ?>">
                ...
                <div class="scroll-area">
                    <div class="modal-body pb0 ptt10">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('type_descriptions'); ?><small class="req"> *</small> </label>
                                    <input type="hidden" name="nurse" id="nurse_set">
                                    <select name="type_description" style="width: 100%" id="type_description" class="form-control select2">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php foreach ($type_description as $key => $value) { ?>
                                            <option value="<?php echo $value["id"] ?>"><?php echo $value["type_description_name"]; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('description_comment') ?> <small class="req"> *</small> </label>
                                    <textarea name="note" id="input_description_comment" style="height:700px; width: 900px;" class="form-control compose-textareass-">
                                    </textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" id="description_commentbtn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn btn-info pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
...
<!-- Hoja de ingreso -->
<div class="modal fade" id="add_hoja_ingreso" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close pupclose" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="prescription_title2"></h4>
            </div>
            <form id="form_hoja_ingreso" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <div class="pup-scroll-area">
                    <div class="modal-body pt0 pb0">
                    </div> <!--./modal-body-->
                </div>
...
<script type="text/javascript">
    ...
    function addmedicationModal() {
        ...
        medicationModalDefault();
    }

    function medicationModalDefault(pharmacy_id = null) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                // $("#mdosage").select2("val", '');
                // $("#add_dose_medicine_category").select2("val", 1);
                // $("#add_dose_medicine_category").select2("val", medicine_category_id);
                getMedicineForMedication(1, pharmacy_id);
    ...
    function medicationDoseModal(medication_id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#medicine_dose_edit_id").val(data.dosage);
                // $("#mmedicine_category_edit_id ").val(data.medicine_category_id).trigger('change');
                getMedicineForMedication(1, data.pharmacy_id);
    ...
    function get_hoja_ingreso(ipd_id) {
        $('#prescription_title2').html('<?php echo $this->lang->line('edit_hoja_ingreso'); ?>');

        $.ajax({
            url: base_url + 'admin/prescription/get_hoja_ingreso',
            dataType: 'JSON',
            data: {
                'ipd_id': ipd_id
            },
            ...
            beforeSend: function() {},
            success: function(res) {
                $('.modal-body', "#add_hoja_ingreso").html(res.page);
                $('#add_hoja_ingreso').modal('show');
            },
    ...
    function print_medicamentos(ipd_id) {
        $('#prescription_title_medicamento').html('<?php echo $this->lang->line('historial_medicamento'); ?>');
    ...
    function print_medicamentos_2(ipd_id) {
        $('#prescription_title_medicamento').html('<?php echo $this->lang->line('historial_medicamento'); ?>');
    ...
    function print_medicamentos_print(ipd_id) {
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/prescription/print_medicamentos/',
            type: 'GET',
    ...
    function printHojaIngreso(visitid) {
        console.log('errrr', visitid);
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/prescription/print_hoja_ingreso',
            type: 'GET',
            data: {
                ipd_id: visitid
            },
    ...
    $("#form_hoja_ingreso").on('submit', (function(e) {
        // var sub_btn_clicked = $("button[type=submit][clicked=true]");
        // var sub_btn_clicked_name = sub_btn_clicked.attr('name');
        var sub_btn_clicked = $(document.activeElement);
        var sub_btn_clicked_name = sub_btn_clicked.attr('name');

        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>admin/patient/add_hoja_ingreso_hospitalized',
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
            ...
            success: function(data) {
                if (data.status == "0") {
                    ...
                    if (sub_btn_clicked_name === "save_print") {
                        ...
                        printHojaIngreso(data.ipd_id, true);
                    }
                    $('#add_hoja_ingreso').modal('hide');
    ...
    function view_prescription(id, ipdid, discharged = '') {
        ...
        if (discharged != "yes") {
            $('#edit_deleteprescription').html("<?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_view')) { ?><a href='#prescription' onclick='printprescription(" + id + ")' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_edit')) { ?><a href='#prescription' onclick='edit_prescription(" + id + ")' data-target='#edit_prescription'  data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if ($this->rbac->hasPrivilege('ipd_prescription', 'can_delete')) { ?><a onclick='delete_prescription(" + id + ")'    data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
        } else {
    ...
    $(document).ready(function(e) {
        ...
        $("#admission_note_form").on('submit', (function(e) {

            var nurse_id = $("#nurse_field").val();
            $("#nurse_set").val(nurse_id);
            $("#admission_notebtn").button('loading');
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/add_admission_note',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    ...
                    $("#admission_notebtn").button('reset');
        ...
        $("#description_comment_form").on('submit', (function(e) {
            // var nurse_id = $("#nurse_field").val();
            // $("#nurse_set").val(nurse_id);
            $("#description_commentbtn").button('loading');
            e.preventDefault();
            // return false;
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/add_description_comment',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    ...
                    $("#description_commentbtn").button('reset');
                },
                error: function() {
        ...
        $('#type_description').on('change', function(e) {

            let id = $('#type_description').val();
            ...
            $.ajax({
                url: base_url + 'admin/patient/get_data_type_description/',
                type: 'POST',
                data: {
                    id: id
                },
                ...
                success: function(data) {
                    if (data.template) {
                        // $('#input_description_comment').val('asasas');
                        $('#input_description_comment').val(data.template);
                        ...
                        //         return "<li>" +
                        //             "<div class='btn-group'>" +
                        //             "<a class='btn' data-wysihtml5-action='change_view' title='ed'>HTML</a>" +
                        //             "</div>" +
                        //             "</li>";
                        //     }
                        // }
                        ...
                        // $('#input_description_comment').wysihtml5({
                        //     customTemplates: myCustomTemplates
                        // });

                        var nuevoContenido = "Este es el contenido nuevo";

                        // Establece el contenido en el editor wysihtml5
                        // $('#input_description_comment').data("wysihtml5").editor.setValue(nuevoContenido);

                        // $('#input_description_comment').wysihtml5(); // Inicializar (si no lo has hecho)

                        // setTimeout(function() {
                        //     $('#input_description_comment').data("wysihtml5").editor.setValue("Texto cargado dinámicamente");
                        // }, 500); // Esperar un poco para asegurarte de que el editor esté listo

                        // $('#some-textarea').wysihtml5({
                        //     customTemplates: myCustomTemplates
                        // });

                        // var editor = $('#input_description_comment')
                        // .wysihtml5({toolbar: {
                        //     "image": false,
                        // }})
                        // .data('wysihtml5').editor;
                        // editor.setValue(template, true);
