    ...
    <div class="col-sm-12">
        <div class="ptt10">
            <div class="row">
                        ...
                        <td>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                <div class="">
                                    ...
                                    <select class="form-control select2 medicine_name" data-rowid="1" style="width: 100%" name="medicine_1" id="medicine_1">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    </select>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6" >
                                <div class="">
                                    ...
                                    <!-- <select style="display:none;" class="form-control select2 medicine_dosage" style="width: 100%" name="dosage_1">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    </select> -->
                                    <input type="text" class="form-control" name='dosage_1' />
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                <div class="">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label><?php echo $this->lang->line('other_therapeutic_orders'); ?></label>
                        <!-- <label><?php // echo $this->lang->line('footer_note'); 
                                    ?></label> -->
