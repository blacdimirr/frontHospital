            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs navlistscroll">
                        ...
                        <?php if ($this->rbac->hasPrivilege('opd_timeline', 'can_view')) { ?>
                            <li style="display:none;">
                                <a href="#print_historial_clinica" data-toggle="tab" aria-expanded="true"><i class="far fa-calendar"></i> <?php echo $this->lang->line('print_historial_clinica'); ?></a>
                            </li>
                        <?php } ?>
                    ...
                    <div class="tab-content">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover " data-export-title="<?php echo composePatientName($result['patient_name'], $result['id']) . " " . $this->lang->line('opd_details'); ?>">
                                                        <?php if (!empty($patientdetails['patient']['visitdetails'])) { ?>
                                                            <thead>
                                                                ...
                                                                <th><?php echo $this->lang->line('diagnostico'); ?></th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($patientdetails['patient']['visitdetails'] as $value) {
                                                                    ...
                                                                    if ($i <= $recent_record_count) {
                                                                        $opd_id = $this->customlib->getSessionPrefixByType('DAR-FO') . $value['opd_id'];
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <?php // echo  nl2br($value['refference']); 
                                                                                ?>
                                                                                <a href="<?php echo base_url() . 'admin/patient/visitdetails/' . $id . '/' . $value['opd_id'] . '#admission_diagnosis'; ?>">Ver...</a>
                                                                            </td>
                        ...
                        <div class="tab-pane" id="print_historial_clinica">
                            <div class="box-tab-header">
                                <h3 class="box-tab-title"><?php echo $this->lang->line('print_historial_clinica'); ?></h3>
                            </div>



                            <form id="add_print_historial_clinica" accept-charset="utf-8" enctype="multipart/form-data" method="post" class="">
                                ...
                                <div class="row">
                                    <div class="">
                                        ...
                                        // echo display_custom_fields_patient('patient', 1824)
                                        ?>
                                    </div>
                                </div>
                            ...
                            <div class="row row-eq">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <input name="_asc" disabled type="text" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-sm-3 col-xs-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-3 col-xs-4" style="display: none;">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div><select name='symptoms_type[]' multiple="multiple" id="act" class="form-control select2 act 75" style="width:100%">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-eq ptt10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small> <input readonly type="text" name="amount" id="edit_visit_payment" class="form-control" value="">
    ...
    <div class="modal-dialog modal-mid modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('orden_medica'); ?></h4>
            </div>
            <div class="scroll-area">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        ...
                                        <div class="row ptt10" id="patientDetails">
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                ...
                                                <input name="payment_mode" type="hidden" value="Other" class="form-control" />
                                                <input name="paid_amount" type="hidden" value="0" class="form-control" />
                                                <input name="applied_charge" type="hidden" value="0" class="form-control" />
                                                <input name="amount" type="hidden" value="0" class="form-control" />

                                                <input name="charge_id" type="hidden" value="1" class="form-control" />
                                                <ul class="singlelist">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2 col-xs-4">
                                                <div class="form-group">
                                                    <label for="pwd"><?php echo $this->lang->line('height'); ?></label>
                                                    <input name="height" id="revisit_height" type="number" min="1" class="form-control" value="<?php echo set_value('height'); ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-2 col-xs-4">
                                                <div class="form-group">
                                                    <label for="pwd"><?php echo $this->lang->line('weight'); ?></label>
                                                    <input name="weight" id="revisit_weight" type="number" min="1" class="form-control" value="<?php echo set_value('weight'); ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-xs-6">
                                                <div class="form-group">
                                                    <label for="act">
                                                        <?php echo $this->lang->line('symptoms_type'); ?></label>
                                                    <div><select name='symptoms_type[]' multiple id="act" class="form-control select2 act" style="width:100%">
                                                            <!-- <option value=""><?php echo $this->lang->line('select') ?></option> -->
                                                            <?php foreach ($symptomsresulttype as $dkey => $dvalue) {
                                                            ?>
                                                                <option value="<?php echo $dvalue["id"]; ?>"><?php echo $dvalue["symptoms_type"]; ?></option>
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="symptoms" id="esymptoms" class="form-control" cols="40" rows="5"><?php echo set_value('symptoms'); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                            ...
                                            <div class="">
                                                <?php
                                                echo display_custom_fields_patient('opd');
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control df" name='bed_group_id' onchange="getBed(this.value,'','yes')">
                                                            <option value=""><?php echo $this->lang->line('select') ?></option>
...
<!-- Add Formulario interconsulta -->
<div class="modal fade" id="add_form_interconsultation" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close pupclose" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="interconsultation_title"></h4>
            </div>
            <form id="form_interconsultation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <div class="pup-scroll-area">
                    <div class="modal-body pt0 pb0">
                    </div> <!--./modal-body-->
                </div>
...
</div><!-- Add Formulario interconsulta  -->

<!-- -->
<div class="modal fade" id="edit_hoja_ingreso" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('edit_hoja_ingreso'); ?></h4>
            </div>

            <div class="modal-body pt0 pb0" id="editdetails_hoja_ingreso">
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function edit_prescription(id) {
        $("#prescription_title").html('<?php echo $this->lang->line('edit_orden_medica'); ?>');
        $.ajax({
    ...
    function edit_hoja_ingreso(id) {
        console.log(478);
        $("#prescription_title2").html('<?php echo $this->lang->line('edit_hoja_ingreso'); ?>');
        $.ajax({
            url: base_url + 'admin/prescription/editopdHojaIngreso/' + id,
            dataType: 'JSON',
            data: {
                'prescription_id': id
            },
            ...
            success: function(res) {
                ...
                var medicineTable = $('.modal-body', "#add_hoja_ingreso").find('table#tableID');
                medicineTable.find('.select2').select2();
    ...
    function edit_formulario_interconsulta(id) {
        console.log(479);
        $("#interconsultation_title").html('<?php echo $this->lang->line('edit_formulario_interconsulta'); ?>');
        $.ajax({
            url: base_url + 'admin/prescription/editopdFomrularioInterconsulta/' + id,
            dataType: 'JSON',
            data: {
                'prescription_id': id
            },
            ...
            beforeSend: function() {
                ...
                // form_interconsultation
                // add_form_interconsultation

            },
            success: function(res) {
                // $('#prescriptionview').modal('hide');
                $('.modal-body', "#add_form_interconsultation").html(res.page);
                var medicineTable = $('.modal-body', "#add_form_interconsultation").find('table#tableID');
                medicineTable.find('.select2').select2();
                $('.modal-body', "#add_form_interconsultation").find('.multiselect2').select2({
                    placeholder: 'Select',
                    allowClear: false,
                    minimumResultsForSearch: 2
                });

                $('#add_form_interconsultation').modal('show');
            },
    ...
    function deseocupar_cama(case_reference_id) {

        if (confirm("Desea deseocupar esta cama?")) {
            $.ajax({
                url: baseurl + 'admin/patient/deseocupar_cama',
                type: "POST",
                data: {
    ...
    $(document).on('click', '.print_historial_clinica', function() {
        var opd_id = $(this).data('opdId');

        var $this = $(this);

        $.ajax({
            url: base_url + 'admin/patient/print_historial_clinica',
            type: "POST",
            data: {
                opd_id: opd_id
            },
    ...
    function getRecord_id(visitid) {
        ...
        $('#prescription_title').html('<?php echo $this->lang->line('add_orden_medica'); ?>');
        $.ajax({
    ...
    function getRecord_id_orden_medica(visitid) {

        $('#prescription_title').html('<?php echo $this->lang->line('add_prescription'); ?>');
        $.ajax({
            url: base_url + 'admin/prescription/addOrdenMedica',
            dataType: 'JSON',
            data: {
                'visit_detail_id': visitid
            },
    ...
    function getRecord_interconsulta(case_reference_id, visitid, patientid) {
        $('#interconsultation_title').html('<?php echo $this->lang->line('Interconsultation'); ?>');
        $.ajax({
            url: base_url + 'admin/prescription/addInterconsultation',
            dataType: 'JSON',
            data: {
                'case_reference_id': case_reference_id,
                'visit_detail_id': visitid,
            ...
            success: function(res) {
                ...
                // add_form_interconsultation
                $('.modal-body', "#add_form_interconsultation").html(res.page);
                $('.modal-body', "#add_form_interconsultation").find('table').find('.select2').select2();
                $('.modal-body', "#add_form_interconsultation").find('.multiselect2').select2({
                    placeholder: 'Select',
                    allowClear: false,
                    minimumResultsForSearch: 2
    ...
    function getRecord_id_hoja_ingreso(case_reference_id, visitid, patientid) {
    ...
    function editRecord(visitid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.symptoms_type){
                    let items = [];                    
                    data.symptoms_type.forEach((item) => {
                        items.push(item.symptoms_type_id);
                    });
                    console.log(items);

                    $('#act').val(items).trigger("change");
                }
                holdModal('editModal');
            },
        });
    ...
    $(document).ready(function(e) {
        ...
        $("form#form_hoja_ingreso button[type=submit]").click(function() {
            $("button[type=submit]", $(this).parents("form")).removeAttr("clicked");
            $(this).attr("clicked", "true");
        });
        $("form#form_interconsultation button[type=submit]").click(function() {
            $("button[type=submit]", $(this).parents("form")).removeAttr("clicked");
            $(this).attr("clicked", "true");
        });
        ...
        $("#form_hoja_ingreso").on('submit', (function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/add_hoja_ingreso',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    if (data.status == "0") {
                        ...
                        if (sub_btn_clicked_name === "save_print") {
                            ...
                            printHojaIngreso(data.visitid, true);
                        }
        ...
        $("#form_interconsultation").on('submit', (function(e) {
            var sub_btn_clicked = $("button[type=submit][clicked=true]");
            var sub_btn_clicked_name = sub_btn_clicked.attr('name');
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/addInterconsultation',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    if (data.status == "0") {
                        ...
                        if (sub_btn_clicked_name === "save_print") {
                            console.log(data);
                            printHojaInterconsulta(data.visitid, true);
                        }
                        $('#add_form_interconsultation').modal('hide');
                        $('.ajaxlistvisit').DataTable().ajax.reload();
                    }
                    sub_btn_clicked.button('reset');
                },
    ...
    $(document).ready(function(e) {
        ...
        $("#add_print_historial_clinica").on('submit', (function(e) {
            // $("#add_timelinebtn").button('loading');
            var patient_id = $("#patient_id").val();
            console.log(478);
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url("admin/patient/add_print_historial_clinica") ?>",
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    function view_prescription_hoja_ingreso(visitid) {
        $.ajax({
            url: '<?php echo base_url(); ?>admin/prescription/getPrescription_hoja_ingreso/' + visitid,
            success: function(res) {
                $("#getdetails_prescription").html(res);
            },
            error: function() {
        ...
        holdModal('prescriptionview_hojaIngreso');
    }
    ...
    function calcularASC() {
        ...
        console.log($('input[name="height"]').val(),$('input[name="weight"]').val());
        if (!isNaN(height) && !isNaN(weight)) {
            let resultado = (weight * height) / 3600;
            resultado = resultado.toFixed(3);
            $('input[name="_asc"]').val(resultado);
        } else {
            $('input[name="_asc"]').val('');
        }
    }
...
<script type="text/javascript">
    ...
    function getRevisitRecord(opdid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // 
                let height = parseFloat(data.weight);
                let weight = parseFloat(data.height);
                let res = (height * weight / 3600);
                
                $('input[name="_asc"]').val(res);
                // 
    ...
    function printHojaIngreso(visitid) {
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/prescription/printHojaIngreso',
            type: 'GET',
            data: {
                visitid: visitid
            },
    ...
    function printHojaInterconsulta(visitid) {
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/prescription/printHojaInterconsulta',
            type: 'GET',
            data: {
                visitid: visitid
            },
...
<script type="text/javascript">
    ...
    function getBed2(bed_group, bed = '', active, htmlid = 'bed_no') {
        console.log(45);
        var div_data = "";
        $('#' + htmlid).html("<option value='l'><?php echo $this->lang->line('loading') ?></option>");
        $("#" + htmlid).select2("val", 'l');
