        ...
        <div class="ptt10">
            ...
            <div class="col-sm-12"> 
                ...
                <div class="col-sm-12">
                 ...
                 <div class="col-sm-12"> 
                    <h4>
                        <?php echo $this->lang->line('other_therapeutic_orders'); ?>
                    </h4>
                </div>
                <div class="col-sm-12">
                ...
                <div class="ptt10">
                    ...
                    <?php
                        foreach ($roles as $role_key => $role_value) {
                            if (in_array($role_value['name'],array('Doctor','Enferemera'))){
                                $userdata = $this->customlib->getUserData();
                                $role_id = $userdata["role_id"];?>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="visible[]" value="<?php echo $role_value['id']; ?>" <?php if ($role_value["id"] == $role_id) { echo "checked onclick='return false;'";  } ?> <?php echo set_checkbox('visible[]', $role_value['id'], false) ?> />
