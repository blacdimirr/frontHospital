                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/itempurchasingprocess/add" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <select name="suplidores" id="suplidores" class="form-control select2">
                                ...
                                <div class="col-md-12">
                                    <h5 class="section-title change-text"><?php echo $this->lang->line('Search order'); ?></h5>
                                    <div id="div_id" class="">
                                    </div>
                                    <br />
                                </div>
...
<script type="text/javascript">
    ...
    function get_details_compra() {
        ...
        $(".change-text").text("<?php echo $this->lang->line('searching'); ?>");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(_data.products, function(i, obj) {
                    ...
                    $('#div_id').append(div);
                    $(".change-text").text("<?php echo $this->lang->line('Search order'); ?>");
                });
            }
        });
    }
