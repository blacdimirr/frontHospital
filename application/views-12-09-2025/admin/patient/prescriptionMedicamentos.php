    ...
    <div class="body-pdf">
        <div class="print-area">
            ...
            <div class="form-section">
                ...
                <div class="grid-2col">
                    <div>NO. DE EXPEDIENTE CLINICO: <span class="input-field"><?php echo 'DAR-FO'.$result->ipd_id; ?></span></div>
            ...
            <div class="form-section">
                ...
                <table class="form-table">
                    <tr>
                      ...
                      <!-- <?php $medsl =''; foreach ($medicines as $pkey => $pvalue) { $medsl++; ?> -->
                        <tr>
                            <!-- <td class="text text-center"><?php echo $pvalue->medicine_name; ?></td> -->
                            <!-- <td class="text text-center"><?php echo $pvalue->dosage ?></td> -->
                    ...
                    <?php
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $medicines[$i]['dosage']; ?></td>
                                    <td><?php echo $this->customlib->getHospitalTime_Format($medicines[$i]['time']); ?></td>
                                    <td><?php echo $medicines[$i]['medication_notes']; ?></td>
                                </tr>
                        <?php
                            }
                        }
