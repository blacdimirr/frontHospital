                        ...
                        <table class="table table-striped table-bordered table-hover ajaxlist" data-export-title="<?php echo $this->lang->line('opd_patient'); ?>">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo $this->lang->line('is_hospitalized'); ?></th>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select class="form-control" name='bed_group_id' onchange="getBed2(this.value,'','yes')">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
...
<script type="text/javascript">
    ...
    function getdoctor(id, doc = '') {
        var div_data = "";
        $('#consultant_doctor').html("<option value='l'><?php echo $this->lang->line('loading') ?></option>");
...
<script type="text/javascript">
    (function($) {
        ...
        $(document).ready(function() {
            initDatatable2('ajaxlist', 'admin/patient/getopddatatable', [], [], 100);
        });
    }(jQuery))
</script>
<!-- //========datatable end===== -->
