    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <h3 class="box-title titlefix"><?php echo $this->lang->line('interconsulta_details'); ?></h3>
              ...
              <table class="table table-striped table-bordered table-hover ajaxlist" data-export-title="<?php echo $this->lang->line('appointment_details'); ?>" >
                <thead>
                  <tr>
                    ...
                    <?php } ?>
                    <th width="150" class="text-right"><?php echo $this->lang->line('was_visited'); ?></th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
...
function getBed(bed_group, bed = '', active, htmlid = 'bed_no') {
      ...
      function visitado(case_reference_id){

        if(confirm("Fue visitado este paciente?")){
              $.ajax({
                url: baseurl + 'admin/interconsultation/visitado',
                type: "POST",
                data: {
                    '_id': case_reference_id
                },
                dataType: 'json',
                success: function(data) {
...
( function ( $ ) {
  ...
  $(document).ready(function () {
    initDatatable('ajaxlist','admin/interconsultation/getappointmentdatatable',[],[],100);
  });
} ( jQuery ) ) 
</script>
<!-- //========datatable end===== -->
