                ...
                <div class="nav-tabs-custom relative">
                    ...
                    <ul class="nav nav-tabs navlistscroll">
                        ...
                        <?php if ($this->rbac->hasPrivilege('opd_medication', 'can_view')) { ?>
                            <li>
                                <a href="#orden_medica" data-toggle="tab" aria-expanded="true"><i class="fas fa-sticky-note"></i> <?php echo $this->lang->line('orden_medica'); ?></a>
                            </li>
                        <?php } ?>
                        <?php if ($this->rbac->hasPrivilege('opd_medication', 'can_view')) { ?>
                            <li>
                                <a href="#admission_diagnosis" data-toggle="tab" aria-expanded="true"><i class="fas fa-sticky-note"></i> <?php echo $this->lang->line('admission_diagnosis'); ?></a>
                            </li>
                        <?php } ?>
                    ...
                    <div class="tab-content pt6">
                        <div class="tab-pane tab-content-height  active" id="overview">
                            ...
                            <div class="row">
                                    ...
                                    <div class="box-header border-b mb10 pl-0 pt0">
                                        ...
                                        <div class="pull-right">
                                            <div class="editviewdelete-icon pt8 text-center">
                                                ...
                                                <?php }
                                                if ($this->rbac->hasPrivilege('opd_patient_discharge', 'can_view')) { ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="box-tab-header">
                                        <h3 class="box-tab-title"><?php echo $this->lang->line('admission_diagnosis'); ?></h3>
                                    </div>
                                    <div class="timeline-header no-border">
                                        <div id="timeline_list">
                                    ...
                                    <div id="">
                                        <?php if (empty($diagnosticos_ingresos)) { ?>
                                            <div class="alert alert-danger"><?php echo $this->lang->line('no_record_found'); ?></div>
                                        <?php } else { ?>
                                            <ul class="timeline timeline-inverse">
                                                <?php
                                                foreach ($diagnosticos_ingresos as $key => $value) {
                                                    $id = $value['id'];
                                                ?>
                                                    <li class="time-label">
                                                        <span class="bg-blue">
                                                            <?php echo $this->customlib->YYYYMMDDHisTodateFormat($value['presdate']); ?></span>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-list-alt bg-blue"></i>
                                                        <div class="timeline-item">
                                                            ...
                                                            <div class="timeline-body">
                                                                <?php echo " <p> <b> Enfermedad:</b> </p>" . nl2br($value['search']); ?>
                                                                <?php echo " <p> <b> Diagnóstico:</b> </p>" . nl2br(empty($value['diagnosticos_text']) ? '' : $value['diagnosticos_text']); ?>
                                                            </div>
                                                        </div>
                                                    </li>
                                                <?php } ?>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                                <td class="dosehover">
                                                                    <?php
                                                                    echo $this->lang->line('time') . ": " . date('h:i A', strtotime($mvalue['dose_list'][$x]['time'])) . "</a><span>" . $medication_edit . "</span><span>" . $medication_delete . "</span></br>" . $mvalue['dose_list'][$x]['dosage'];
                        ...
                        </div><!-- Add hoja de ingreso -->
                        <!-- Orden de ingreso -->
                        <div class="tab-pane tab-content-height " id="orden_medica">
                            <div class="box-tab-header">
                                <h3 class="box-tab-title"><?php echo $this->lang->line('orden_medica'); ?></h3>
                                <div class="box-tab-tools">
                                    ...
                                    // if ($is_discharge) {
                                    ?>
                                    <a href="#" class="btn btn-sm btn-primary dropdown-toggle addnursenote" onclick="getRecord_id(<?php echo $visitminid; ?>)" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add_orden_medica'); ?></a>
                                    <?php
                                    // }
                                    // }
                                    ?>
                            ...
                            <div class="download_label" style="display: none;">
                                <?php echo composePatientName($result['patient_name'], $result['patient_id']) . " " . $this->lang->line('ipd_details'); ?>
                            </div>

                            <div id="">
                                <?php if (empty($ordenes_medica)) { ?>

                                    <div class="alert alert-danger"><?php echo $this->lang->line('no_record_found'); ?></div>
                                <?php } else { ?>
                                    <ul class="timeline timeline-inverse">
                                        <?php
                                        foreach ($ordenes_medica as $key => $value) {
                                            $id = $value['id'];
                                            //  print_r($value);
                                            //  die();
                                        ?>
                                            ...
                                            <li>
                                                ...
                                                <div class="timeline-item">
                                                    <?php if ($is_discharge) {
                                                        if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                            <span class="time">
                                                                ...
                                                                <a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_record_orden_medica('<?php echo $value['prescription_id']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>
                                                            </span>
                                                    <?php }
                                                    ...
                                                    ?>
                                                            <span class="time">
                                                                <a onclick="view_prescription_id('<?php echo $value['prescription_id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                    <i class="fa fa-print"></i>
                                                                </a>
                                                            </span>
                                                            <span class="time">
                                                                <a onclick="edit_orden_medica('<?php echo $value['prescription_id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                            </span>
                                                    <?php }
                                                    ...
                                                    <div class="timeline-body">
                                                        <?php echo "</br>" . nl2br($value['header_note']); ?>
                                                        <?php echo "</br>" . nl2br($value['footer_note']); ?>
                                                    </div>
                                                </div>
                                            </li>
                                        <?php } ?>
                        ...
                        <div class="tab-pane tab-content-height " id="admission_diagnosis">
                            <div class="box-tab-header">
                                <h3 class="box-tab-title"><?php echo $this->lang->line('admission_diagnosis'); ?></h3>
                                <div class="box-tab-tools">
                                    <!-- <a href="#" class="btn btn-sm btn-primary dropdown-toggle addnursenote" onclick="getRecord_id(<?php echo $visitminid; ?>)" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add_admission_diagnosis'); ?></a> -->
                                    <a href="#" class="btn btn-sm btn-primary dropdown-toggle addnursenote" onclick="holdModal('add_admission_diagnosis')" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add_admission_diagnosis'); ?></a>
                                </div>
                            </div><!--./box-tab-header-->
                                        ...
                                        ?>
                                            ...
                                            <li>
                                                ...
                                                <div class="timeline-item">
                                                    <?php if ($is_discharge) {
                                                        if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                            <span class="time">
                                                                ...
                                                                <a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_record_admission_diagnosis('<?php echo $value['diagnosticos_id']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>
                                                            </span>
                                                    <?php }
                                                    ...
                                                    ?>
                                                            <!-- <span class="time">
                                                                <a onclick="view_prescription_id('<?php echo $value['diagnosticos_id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                    <i class="fa fa-print"></i>
                                                                </a>
                                                            </span> -->
                                                            <span class="time">
                                                                <a onclick="edit_admission_diagnosis('<?php echo $value['diagnosticos_id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                            </span>
                                                    <?php }
                                                    ...
                                                    <div class="timeline-body">
                                                        <?php echo " <p> <b>Enfermedad:</b> </p>" . nl2br($value['search']); ?>
                                                        <?php echo "</br> <p><b>Diagnóstico: </b></p>" . nl2br(empty($value['diagnosticos_text']) ? '' : $value['diagnosticos_text']); ?>
                                                    </div>
                                                </div>
                                            </li>
                                        <?php } ?>
...
<!-- modal diagnostico ingreso -->
<div class="modal fade" id="add_admission_diagnosis" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-lg-content">
            <div class="modal-header modal-lg-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_admission_diagnosis'); ?> </h4>
            </div>

            <form id="admission_diagnosis_form" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <!-- <input name="patient_id" placeholder="" id="nurse_patient_id" value="<?php echo $result["id"] ?>" type="hidden" class="form-control" /> -->
                <input type="hidden" name="visit_details_id" value="<?php echo $visitminid ?>">
                <input type="hidden" name="diagnosticos2" id="diagnosticos2">
                ...
                <div class="scroll-area">
                    <div class="modal-body pb0 ptt10">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('Search for disease'); ?>
                                        <!-- <small class="req"> *</small> -->
                                    </label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Introduzca el condicion medica..." id="search" name="search" />
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn btn-secondary " onclick="make_request()"><?php echo $this->lang->line('Search for diagnosis'); ?></button>
                                </div>
                            </div>

                            <div class="col-sm-12">
                                <div class="form-group">
                                    <select class="form-control select2" style="width:100%" id="diagnosticos" name='diagnosticos'>
                                    </select>
                                </div>
                                <!-- start right content -->
                                <div class="">
...
<!-- editmodal diagnostico ingreso -->
<div class="modal fade" id="edit_admission_diagnosis" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-lg-content">
            <div class="modal-header modal-lg-header" style="height: 50px;">
                <button type="button" class="close close_button" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('edit_admission_diagnosis'); ?> </h4>
            </div>

            <form id="admission_diagnosis_form_edit" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <!-- <input name="patient_id" placeholder="" id="nurse_patient_id" value="<?php echo $result["id"] ?>" type="hidden" class="form-control" /> -->
                <input type="hidden" name="visit_details_id" value="<?php echo $visitminid ?>">
                <input type="hidden" name="diagnosticos2" id="diagnosticos2">
                ...
                <div class="scroll-area">
                    <div class="modal-body pb0 ptt10">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Introduzca el condicion medica..." id="edit_search" name="search" />
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn btn-secondary " onclick="make_request()"><?php echo $this->lang->line('Search for diagnosis'); ?></button>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <select class="form-control select2" style="width:100%" id="edit_diagnosticos" name='diagnosticos'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mdosage" name='dosage' />
                                <span class="text-danger"><?php echo form_error('dosage'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="medicine_dose_edit_id" name='dosage_id' />
...
<div class="modal fade" id="add_prescription" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header" style="height: 50px;">
                <button type="button" class="close pupclose" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body pt0 pb0">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input type="hidden" name="apply_amount" value="0">
                                <input type="hidden" name="amount" value="0">
                                <input type="hidden" name="charge_id" value="1">
                                <input type="hidden" name="charge_category" value="1">
...
<script type="text/javascript">
    ...
    function getMedicineDefault(medicine_id = null) {
        // console.log(73);
    ...
    function getMedicineForMedication(medicine_category, medicine_id) {
        console.log(medicine_category, medicine_id, 74);
...
<script type="text/javascript">
    ...
    function medicationDoseModal(medication_id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#medicine_dosage_medication_notes").val(data.medication_notes);
    ...
    function editRecord(visitid) {
        ...
        $.ajax({
            //url: '<?php //echo base_url(); 
                    ?>admin/patient/getopdvisitdetails',
    ...
    function delete_record_admission_diagnosis(id) {
        // console.log(7854);
        if (confirm(<?php echo "'" . $this->lang->line('delete_confirm') . "'"; ?>)) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/updateAdmissionDiagnosis',
                type: "POST",
                data: {
                    id: id
                },
    ...
    function delete_record_orden_medica(id) {
        // console.log(7854);
        if (confirm(<?php echo "'" . $this->lang->line('delete_confirm') . "'"; ?>)) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/interconsultation/updateOrdenMedica/',
                type: "POST",
                data: {
                    id: id
                },
    ...
    function edit_admission_diagnosis(id) {
        // $("#prescription_title").html('<?php echo $this->lang->line('edit_prescription'); ?>');

        $.ajax({
            url: base_url + 'admin/patient/editAdmissionDiagnosis',
            dataType: 'JSON',
            data: {
                'id': id
            },
            ...
            success: function(res) {
                setTimeout(() => {
                    make_request(res.data.result[0].search);
                }, 1000);

                $('#edit_admission_diagnosis').modal('show');
                console.log(res.data.result[0].diagnosticos);
                // res.data.result[0].search
                $('#edit_search').val(res.data.result[0].search);

                setTimeout(() => {
                    $('#edit_diagnosticos').val(res.data.result[0].diagnosticos);
                }, 2000);
    ...
    function edit_orden_medica(id) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                medicineTable.find("tbody tr").each(function(e,i) {
                    // console.log(e,i) ;

                    var medicine_category_obj = $('#row'+(e+1)).find("td .medicine_name");
                    // var post_medicine_category_id = $(this).find("td input.post_medicine_category_id").val();
                    // var post_medicine_id = $(this).find("td input.post_medicine_id").val();
                    // var dosage_id = $(this).find("td input.post_dosage_id").val();
                    // var medicine_dosage = getDosages(post_medicine_category_id, dosage_id);
                    ...
                    // getMedicine(medicine_category_obj, post_medicine_category_id, post_medicine_id);
                    // getMedicine($('table#tableID'), 1, 0);
                    getMedicine(medicine_category_obj, 1, 0);
    ...
    function make_request(text = null) {
        // var send = $('#search').val();
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.each(res.data.destinationEntities, function(i, obj) {
                        ...
                        // var sel = "";
                        div_data += "<option value='" + obj.id + "'>" + obj.theCode + " - " + obj.title + "</option>";

                    });
                    if (text) {
                        $('#edit_diagnosticos').html(div_data);
                    } else {
    ...
    $(document).ready(function(e) {
        ...
        $("#admission_diagnosis_form").on('submit', (function(e) {
            // var nurse_id = $("#nurse_field").val();
            // $("#nurse_set").val(nurse_id);
            $("#admission_diagnosisbtn").button('loading');
            e.preventDefault();
            // return false;
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/add_admission_diagnosis',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    ...
                    $("#admission_diagnosisbtn").button('reset');
                },
                error: function() {
        ...
        $("#admission_diagnosis_form_edit").on('submit', (function(e) {
        ...
        $('#diagnosticos').on('change', function(e) {
            let text = $('#diagnosticos option:selected').text();

            $('#diagnosticos2').val(text);
            console.log(78, text);
    ...
    function getRecord_id(visitid) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('.modal-title', "#add_prescription").html('<?php echo $this->lang->line('add_orden_medica'); ?>');
                $('.modal-body', "#add_prescription").html(res.page);
    ...
    $(document).on('click', '.add-record', function() {
        ...
        var div = "<input type='hidden' name='rows[]' value='" + prescription_rows + "' autocomplete='off'><div class='row1'> <div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div>" + medicine_row + "<select class='form-control select2 medicine_name' data-rowId='" + prescription_rows + "'  name='medicine_" + prescription_rows + "' id='search-query" + prescription_rows + "'><option value='l'><?php echo $this->lang->line('select') ?></option></select><small id='stock_info_" + prescription_rows + "''> </small></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div>" + dose_row + "<input type='text' class='form-control' name='dosage_" + prescription_rows + "' id='search-dosage" + prescription_rows + "' /></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div>" + dose_interval_row + " <select  class='form-control select2 interval_dosage' name='interval_dosage_" + prescription_rows + "' id='search-interval-dosage" + prescription_rows + "'><option value='<?php echo set_value('interval_dosage_id'); ?>'><?php echo $this->lang->line('select'); ?></option><?php foreach ($intervaldosage as $dkey => $dvalue) { ?><option value='<?php echo $dvalue["id"]; ?>'><?php echo $dvalue["name"] ?></option><?php } ?></select></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div>" + dose_duration_row + "<select class='form-control select2 duration_dosage' name='duration_dosage_" + prescription_rows + "' id='search-duration-dosage" + prescription_rows + "'><option value='<?php echo set_value('duration_dosage_id'); ?>'><?php echo $this->lang->line('select') ?></option><?php foreach ($durationdosage as $dkey => $dvalue) { ?><option value='<?php echo $dvalue["id"]; ?>'><?php echo $dvalue["name"] ?></option><?php } ?></select></div></div><div class='col-lg-2 col-md-4 col-sm-6 col-xs-6'><div>" + instruction_row + "<textarea style='height:28px' name='instruction_" + prescription_rows + "' class=form-control id=description></textarea></div></div></div>";
    ...
    function view_prescription_id(prescription_id) {
        $.ajax({
            url: '<?php echo base_url(); ?>admin/prescription/getPrescriptionId/' + prescription_id,
            success: function(res) {
...
<script type="text/javascript">
    ...
    function getMedicine(med_cat_obj, val, medicine_id) {
        console.log(medicine_id, 76, 77);
        // var medicine_colomn = med_cat_obj.closest('tr').find('.medicine_name');
        // medicine_colomn.html("");
        if (med_cat_obj) {
            console.log(1, med_cat_obj);
            med_cat_obj = $('.row1');
            var medicine_colomn = med_cat_obj.closest('tr').find('.medicine_name');
            medicine_colomn.html("");
        } else {
            console.log(2, med_cat_obj);
            var medicine_colomn = $('.medicine_name').html("");
        }
...
<script>
    ...
    function getRecord_id_hoja_ingreso() {
        console.log(45);

        $('#prescription_title2').html('<?php echo $this->lang->line('add_hoja_ingreso'); ?>');
        $.ajax({
            url: base_url + 'admin/prescription/addHojaIngreso',
            dataType: 'JSON',
            data: {
            ...
            success: function(res) {
                ...
                $('.modal-body', "#add_hoja_ingreso").find('table').find('.select2').select2();
                $('.modal-body', "#add_hoja_ingreso").find('.multiselect2').select2({
                    placeholder: 'Select',
                    allowClear: false,
                    minimumResultsForSearch: 2
                });
