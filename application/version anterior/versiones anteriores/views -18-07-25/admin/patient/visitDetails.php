                                        ...
                                        $date = $this->customlib->YYYYMMDDTodateFormat($medication_value['date']);
                                          ...
                                          for ($x = 0; $x <= $dosage_count; $x++){
                                            if (array_key_exists($x,$mvalue['dose_list']))
                                                  ...
                                                  ?>
                                                   <td class="dosehover"><?php echo $this->lang->line('time').": ".date('h:i A',strtotime($mvalue['dose_list'][$x]['time']))."</a><span>".$medication_edit."</span><span>".$medication_delete."</span></br>". $mvalue['dose_list'][$x]['dosage']; if($mvalue['dose_list'][$x]['remark']!=''){ echo " <br> <b>".$this->lang->line('remark')."</b>: ".$mvalue['dose_list'][$x]['remark'] ;}?></td>
                                                  <?php
                                                  }
                                                else
                                                  {
                ...
                <div class="scroll-area">
                    <div class="modal-body pb0 ptt10">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <!-- <input type="button" class="btn btn-secondary" onclick="make_request()" /> -->
                                    <button type="button" class="btn btn-secondary " onclick="make_request()">Search</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).on('click','#add_newcharge',function(){ 
    ...
    function make_request(text = null) {
        ...
        if (text){ send = text;} else { send = $('#search').val();}
