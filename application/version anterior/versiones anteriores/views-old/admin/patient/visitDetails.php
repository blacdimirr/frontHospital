                                            ...
                                            foreach ($medication as $medication_key => $medication_value) {
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                                <td class="dosehover"><?php echo $this->lang->line('time') . ": " . date('h:i A', strtotime($mvalue['dose_list'][$x]['time'])) . "</a><span>" . $medication_edit . "</span><span>" . $medication_delete . "</span></br>" . $mvalue['dose_list'][$x]['dosage'];
                                        ...
                                        ?>
                                            ...
                                            <li>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <h3 class="timeline-header text-aqua"> <?php echo $value['name'] . ' ' . $value['surname'] . " ( " . $value['employee_id'] . " )"; ?> </h3>
                                                    <div class="timeline-body">
                                                        <?php echo " <p>Enfermedad: </p>" . nl2br($value['search']); ?>
                                                        <?php echo "</br> <p>Diagnóstico: </p>" . nl2br(empty($value['diagnosticos_text']) ? '' : $value['diagnosticos_text']); ?>
                                                    </div>
                                                </div>
                                            </li>
                                        <?php } ?>
