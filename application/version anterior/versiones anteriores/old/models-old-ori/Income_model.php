...
class Income_model extends MY_Model
{
    ...
    public function getAllRecord()
    {
        ...
        $this->datatables
            ->select('income.id,income.date,income.name,income.invoice_no,income.amount,income.documents,income.note,CONCAT(income_head.income_category," - ",income_head.description) as income_category,income.inc_head_id,income.documents_other, (SELECT SUM(amount) FROM income_payments WHERE income_payments.income_id = income.id) as income_payments  ' . $field_variable)           
