        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                if ($this->rbac->hasPrivilege('income', 'can_edit')) {
                    ...
                    $column_first .= ' <a onclick="income_payment(' . $value->id . ')" class="btn btn-default btn-xs" data-toggle="tooltip" title="' . $this->lang->line('addIncomePayment') . '"> <i class="fa fa-money-bill"></i> </a>';
                }
