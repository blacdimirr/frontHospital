...
<head>
    ...
    <style>
        ...
        .section-title {
            ...
            /* padding: 5px; Añadir un poco de padding para mejor visualización */
...
<body>
    ...
    <div class="form-section">
        ...
        <div class="grid-2col">
            ...
            <div>SALA O HABITACION: <span class="input-field"><?php echo $camas['grupo_cama']; ?></span></div>
            <div>NO DE CAMA: <span class="input-field"><?php echo $camas['cama']; ?></span></div>
