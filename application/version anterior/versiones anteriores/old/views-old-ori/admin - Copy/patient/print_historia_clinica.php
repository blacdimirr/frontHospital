...
<body>
    ...
    <div class="form-section">
        ...
        <div class="grid-2col">
            ...
            <br/>
            <div>Nombres y Apellidos: <span class="input-field"></span></div>
            <div>Género: <span class="input-field"></span> Edad: <span class="input-field"></span></div>
            <div>Teléfono: <span class="input-field"></span></div>
            <div>Nacionalidad: <span class="input-field"></span></div>
            <div>Cédula/Pasaporte: <span class="input-field"></span></div>
            <div>Dirección: <span class="input-field"></span></div>
            <div>Fecha de nacimiento: <span class="input-field"></span></div>
            <div>NSS: <span class="input-field"></span></div>
            <div>Dirección: <span class="input-field"></span></div>
    ...
    <div class="form-section">
        ...
        <div class="checkbox-group">
            <label><input type="checkbox"> Propios Medicos</label>
            <label><input type="checkbox"> Ambulancia 911</label>
            <label><input type="checkbox"> CRUE</label>
            <label><input type="checkbox"> Privada</label>
        </div>
        <div>Referido: </div>
        ...
        <div class="checkbox-group">
            ...
            <label><input type="checkbox"> Naranja</label>
        ...
        <div>Peso: <span class="input-field"></span></div>
        <div>Talla: <span class="input-field"></span></div>
