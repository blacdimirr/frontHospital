    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            if ($this->module_lib->hasActive('appointment')) {
                if (
                    $this->rbac->hasPrivilege('online_appointment_slot', 'can_view') ||
            ...
            ?>
                    <li class="treeview <?php echo set_Topmenu('interconsultation'); ?>">
                        <a href="<?php echo base_url(); ?>admin/interconsultation/index">
                            <i class="fa fa-list"></i> <span><?php echo $this->lang->line('interconsultations'); ?></span>
                        </a>
                    </li>
            <?php
                }
                    ...
                    <li class="treeview <?php echo set_Topmenu('finance'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->module_lib->hasActive('expense')) {
                                if ($this->rbac->hasPrivilege('expense', 'can_view')) {
                            ?>
                                    <li class="<?php echo set_Submenu('purchaseorder/index'); ?>"><a href="<?php echo base_url(); ?>admin/purchaseorder"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('purchase_order'); ?></a></li>
            ...
            ?>
                    <li class="treeview <?php echo set_Topmenu('Inventory'); ?>">
                        ...
                        <a href="<?php echo base_url(); ?>admin/issueitem">
