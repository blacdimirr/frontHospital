...
<div class="">
    ...
    <input type="hidden" name="bed_id" value="<?php echo $bed_id->bed_id ? $bed_id->bed_id : 0 ?>">
    <input type="hidden" name="opd_id" value="<?php echo $patient['opdid'] ?>">

    <input type="hidden" name="credit_limit" value="20000">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <ul class="singlelist">
                        <li>
                            ...
                            <span><?php $dob = $patient['dob'];
                                    echo $this->customlib->getAgeBydob($dob); ?></span>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-xs-4">
                    <div class="form-group">
                        ...
                        <input name="height" type="number" min="1" value="<?php echo $patient['height']; ?>" class="form-control" />
                    </div>
                </div>
                <div class="col-sm-3 col-xs-4">
                    <div class="form-group">
                        <label for="pwd"><?php echo $this->lang->line('weight'); ?></label>
                        <input name="weight" type="number" min="1" value="<?php echo $patient['weight']; ?>" class="form-control" />
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div><input readonly class="form-control" type='text' name='credit_limit' value="<?php echo $setting[0]['credit_limit']; ?>" />
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control" name='bed_group_id' onchange="getBed(this.value,'','yes','bed_no2')">
                                <option value=""><?php echo $this->lang->line('select') ?></option>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div><select class="form-control select2" style="width: 100%" name='bed_no' id='bed_no2'>
                                <option value=""><?php echo $this->lang->line('select') ?></option>
