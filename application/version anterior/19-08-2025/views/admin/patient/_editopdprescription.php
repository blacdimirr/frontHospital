            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <table class="table table-striped table-bordered table-hover">
                        <tr>
                            ...
                            <td> <label><?php echo $this->lang->line('finding_print'); ?> </label><br /><input type="checkbox" name="finding_print" value="yes" <?php if ($result->is_finding_print == 'yes') {
                                                                                                                                                                    echo 'checked';
                                                                                                                                                                } ?>></td>
                        </tr>
                    </table>
                ...
                <table class="table table-striped table-bordered table-hover mb0" id="tableID">
                    ...
                    ?>
                        ...
                        <tr id="row<?php echo $medicine_row ?>" class="row1">
                            <td>
                                ...
                                <div class="col-sm-2 col-xs-6">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" name="dosage_<?php echo $medicine_row ?>" />
                                    </div>
                                </div>
                                <div class="col-sm-2 col-xs-6">
                                    <div class="">
