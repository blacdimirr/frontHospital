...
<input type="hidden" name="formulario_interconsulta_id" value="<?php echo $result->formulario_interconsulta_id; ?>">
        ...
        <div class="ptt10">
            <div class="row">
                ...
                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea style="height:50px" rows="1" name="motivo_interconsulta" class="form-control" id="compose-textareas">
                ...
                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea style="height:50px" rows="1" name="servicio_solicita" class="form-control" id="compose-textareas">
                ...
                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea style="height:50px" rows="1" name="servicio_interconsulta" class="form-control" id="compose-textareas">
                ...
                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea style="height:50px" rows="1" name="evaluacion_interconsulta" class="form-control" id="compose-textareas">
                ...
                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea style="height:50px" rows="1" name="recomendaciones" class="form-control" id="compose-textareas">
                ...
                <div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea style="height:50px" rows="1" name="antecedentes_patologicos_paciente" class="form-control" id="compose-textareas">
