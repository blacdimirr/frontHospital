        ...
        <div class="print-area">
            ...
            <div class="form-section">
                ...
                <div class="grid-2col">
                    ...
                    <div>NO. DE EXPEDIENTE: <span class="input-field"> <?php echo 'DAR-FO-'.$patient->opd_details_id; ?> </span></div>
                    ...
                    <div>NOMBRE DEL PADRE/TUTOR: <span class="input-field-short"><?php echo $patient->guardian_name; ?></span> EDAD: <span class="input-field-short"><?php echo $result->age; ?></span>PESO: <span class="input-field-short"><?php echo $result->weight; ?></span></div>
            ...
            <div class="form-section">
                <div class="section-title"> <?php echo $this->lang->line('motivo_interconsulta'); ?></div>
                <div class="grid-2col">
                    <?php echo $result->motivo_interconsulta; ?>
                </div>
            </div>
            <div class="form-section">
                <div class="section-title"> <?php echo $this->lang->line('servicio_solicita'); ?></div>
                <div class="grid-2col">
                    <?php echo $result->servicio_solicita; ?>
                </div>
            </div>
        
            <div class="form-section">
                <div class="section-title"> <?php echo $this->lang->line('servicio_interconsulta'); ?></div>
                <div class="grid-2col">
                    <?php echo $result->servicio_interconsulta; ?>
                </div>
            </div>
            <div class="form-section">
                <div class="section-title"> <?php echo $this->lang->line('evaluacion_interconsulta'); ?></div>
                <div class="grid-2col">
                    <?php echo $result->evaluacion_interconsulta; ?>
                </div>
            </div>
        
            <div class="form-section">
                <div class="section-title"> <?php echo $this->lang->line('recomendaciones'); ?></div>
                <div class="grid-2col">
                    <?php echo $result->recomendaciones; ?>
                </div>
            </div>

            <div class="form-section">
                <div class="section-title"> <?php echo $this->lang->line('antecedentes_patologicos_paciente'); ?></div>
                <div class="grid-2col">
                    <?php echo $result->antecedentes_patologicos_paciente; ?>
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="grid-2col">
                    <div>
                        <div><span class="info-label">Fecha de Interconsulta</span></div>
                        <div class="info-value"><?php echo date("d/m/Y"); ?></div>
                        <div class="signature-box">
                        </div>
                    </div>
                    <div>
                        <div><span class="info-label">Hora de Interconsulta</span></div>
