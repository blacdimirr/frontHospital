                    ...
                    <div class="row ptt10">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/itempurchasingprocess/add" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('purchasing_process'); ?></label><small class="req"> *</small>
                                ...
                                <div class="form-group col-md-12 col-sm-12">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('note_compra'); ?></label>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(_data.products, function(i, obj) {
                    ...
                    //  item++;
                    var div = "<div class='products-section'> <div class='row'> <div class='form-group col-md-6'> <label for='exampleInputEmail1'><?php echo $this->lang->line('item'); ?></label> <input class='form-control' value='" + obj.name + "' disabled /> </div> <div class='form-group col-md-3'> <label for='exampleInputEmail1'><?php echo $this->lang->line('quantity'); ?></label> <input class='form-control' value='" + obj.quantity + "' disabled  /> </div> <div class='form-group col-md-3'> <label for='exampleInputEmail1'><?php echo $this->lang->line('received_quantity'); ?></label> <input class='form-control' type='number' min='0' name='received_quantity[]' /> <input type='hidden' name='received_sku[]' value='" + obj.sku + "' /> <input type='hidden' name='received_name[]' value='" + obj.name + "' /> </div> </div> </div>";
                    $('#div_id').append(div);
                });
            }
        });
        ...
        // if (confirm('<?php echo $this->lang->line('delete_confirm') ?>')) {
            $.ajax({
                ...
                success: function(res) {
                    ...
                    // $("#getdetails_prescription_medicamentos").html(data.page);
                    popup(data.page);
                },
                error: function() {
                    alert("Fail")
