    ...
    <div class="row">
            ...
            <div class="form-group">
                <div class="radio-container">
                    ...
                    <div class="radio-grid">
                        <label><input type="radio" name="motivoAlta" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['motivoAlta'] === 'ALTA POR ORDEN MÉDICA' ? 'checked' : '';
                                                                        } ?> value="ALTA POR ORDEN MÉDICA" /> ALTA POR ORDEN MÉDICA</label>
                        <label><input type="radio" name="motivoAlta" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['motivoAlta'] === 'DEFUNCIÓN' ? 'checked' : '';
                                                                        } ?> value="DEFUNCIÓN" /> DEFUNCIÓN</label>
                        <label><input type="radio" name="motivoAlta" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['motivoAlta'] === 'TRASLADO' ? 'checked' : '';
                                                                        } ?> value="TRASLADO" /> TRASLADO</label>
                        <label><input type="radio" name="motivoAlta" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['motivoAlta'] === 'FUGA' ? 'checked' : '';
                                                                        } ?> value="FUGA" /> FUGA</label>
                        <label><input type="radio" name="motivoAlta" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['motivoAlta'] === 'ALTA PETICIÓN' ? 'checked' : '';
                                                                        } ?> value="ALTA PETICIÓN" /> ALTA PETICIÓN</label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                <div class="radio-container">
                    <div class="radio-grid">
                        <p>ADMITIDO POR:</p>
                        <label><input type="radio" name="admitidoPor" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['admitidoPor'] === 'CONSULTA EXTERNA' ? 'checked' : '';
                                                                        } ?> value="CONSULTA EXTERNA" /> CONSULTA EXTERNA</label>
                        <label><input type="radio" name="admitidoPor" <?php if (!empty($discharge_card)) {
                                                                            $discharge_card['admitidoPor'] === 'DEFUNCIÓN' ? 'checked' : '';
                                                                        } ?> value="DEFUNCIÓN" /> EMERGENCIA</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="5" name="admitting_diagnosis" class="form-control compose-textareas" >
                    <?php 
                    if (!empty($discharge_card) || !empty($visit_details[0]['admitting_diagnosis']) ) {
                        echo $visit_details[0]['admitting_diagnosis']? $visit_details[0]['admitting_diagnosis']: $discharge_card['admitting_diagnosis'];
                    }
                    ?>
                </textarea>
            </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="1" name="discharge_diagnosis" class="form-control compose-textareas">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="1" name="performed_procedures" class="form-control compose-textareas" >
                    <?php if (!empty($discharge_card)) {
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="1" name="findings" class="form-control compose-textareas">
                    <?php if (!empty($discharge_card)) {
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="1" name="treatment" class="form-control compose-textareas">
                    <?php 
                     if (!empty($discharge_card) || !empty($visit_details[0]['tratamiento']) ) {
                        echo $visit_details[0]['tratamiento']? $visit_details[0]['tratamiento']: $discharge_card['treatment'];
                    }
                    ?>
                </textarea>
            </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="1" name="case_death" class="form-control compose-textareas">
                    <?php if (!empty($discharge_card)) {
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea style="height:200px;" rows="1" name="treatment_appointment" class="form-control compose-textareas">
                    <?php if (!empty($discharge_card)) {
