                                                    ...
                                                    <?php if ($is_discharge) {
                                                        if ($this->rbac->hasPrivilege('nurse_note', 'can_delete')) { ?>
                                                            <span class="time">
                                                                ...
                                                                <a class="btn btn-default btn-xs" onclick="delete_record_admission_diagnosis('<?php echo $value['diagnosticos_id']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>
                                                            </span>
                                                    <?php }
